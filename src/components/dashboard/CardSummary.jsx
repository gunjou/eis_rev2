...
const CardSummary = ({type}) => {
  ...
  switch (type) {
    case "kunjungan":
        card = { title: "Kunjungan", icon: <FaHospital className="text-[#b494ff]"/>, value: 770, trend: 38.5, predict: 23.5, fill: "bg-[#b494ff]/90 p-2 rounded-md drop-shadow-lg"}; break;
    case "pelayanan":
        card = { title: "Pelayanan", icon: <FaStethoscope className="text-[#ffba94]"/>, value: 1829, trend: 40.0, predict: 20.3, fill: "bg-[#ffba94]/90 p-2 rounded-md drop-shadow-lg"}; break;
    case "inventory":
        card = { title: "Inventory", icon: <MdInventory2 className="text-[#6e9ffe]"/>, value: 1050, trend: 18.9, predict: 19.8, fill: "bg-[#6e9ffe]/90 p-2 rounded-md drop-shadow-lg"}; break;
    case "medical-record":
        card = { title: "Medical Record", icon: <FaNotesMedical className="text-[#df3493]"/>, value: 681, trend: 20.2, predict: 18.0, fill: "bg-[#df3493]/90 p-2 rounded-md drop-shadow-lg"}; break;
    case "finance":
