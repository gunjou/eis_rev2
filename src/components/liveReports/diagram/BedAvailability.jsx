  ...
  return (
    <div className="BedAvailability">
        ...
        >
          ...
          <Bar dataKey="terisi" name='Terisi' stackId="a" barSize={15} radius={[0, 0, 0, 0]} fill="#df3493" />
          <Bar dataKey="tersedia" name='Tersedia' stackId="a" barSize={15} radius={[0, 6, 6, 0]} fill="#55caaf" />
        </BarChart>
      </ResponsiveContainer>
		</div>
  )
